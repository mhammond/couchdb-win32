...
// Couch doesn't yet have a great windows build story.  For now,
// compile with MSVC using: 
//  cl couchspawnkillable_win.c /Ox /link /out:couchspawnkillable.exe 
// Then copy couchspawnkillable.exe to your couch '/lib/couchdb/priv'
// directory.
